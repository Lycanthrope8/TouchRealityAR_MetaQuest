...
namespace ARObjectDetection.AprilTag
{
    ...
    public class PoseCorrector : MonoBehaviour
    {
        ...
        public int ActiveCorrectionCount => activeCorrections.Count;
        public int CorrectionsStarted => correctionsStarted;
        public int CorrectionsCompleted => correctionsCompleted;
        ...
        private void ApplyCorrectionStrategy(LatchedTagState state, Pose trackedPoseSite, Pose tagPoseSite, float posErrorSite)
        {
            ...
            else if (config != null && posErrorSite <= config.ConflictThreshold)
            {
